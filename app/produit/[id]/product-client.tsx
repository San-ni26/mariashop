    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8 lg:py-14">
                ...
                <button
                    onClick={() => router.back()}
                    className="mb-6 flex items-center gap-2 text-sm font-medium text-muted-foreground hover:text-foreground transition-colors cursor-pointer"
                >
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                            <button
                                ...
                                className="flex flex-1 items-center justify-center gap-2 rounded-full border border-border bg-card py-4 text-sm font-semibold text-foreground transition-all hover:bg-secondary cursor-pointer"
                            >
                                {added ? (
                            ...
                            <a
                                ...
                                className="flex flex-1 items-center justify-center gap-2 rounded-full bg-emerald-600 py-4 text-sm font-semibold text-white shadow-lg shadow-emerald-600/20 transition-all hover:-translate-y-0.5 hover:bg-emerald-700 cursor-pointer"
                            >
                        ...
                        <button
                            onClick={handleShare}
                            className="mt-4 flex items-center justify-center gap-2 text-xs text-muted-foreground hover:text-foreground transition-colors cursor-pointer"
                        >
